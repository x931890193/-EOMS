...
def get_os_info():
	...
	disk_data_p = psutil.disk_usage('/home/kali/Desktop/keke/data').percent
	...
	net_conn = int(os.popen('echo '+PASSWORD+' | sudo -S netstat -anputl|grep "ESTABLISHED"|wc -l').readline().strip())
